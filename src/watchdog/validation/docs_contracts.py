...
DOC_CONTRACT_CHECKS: tuple[DocContractCheck, ...] = (
    ...
    DocContractCheck(
        ...
        must_contain=(
            ...
            "WATCHDOG_SMOKE_PROVIDER_HTTP_TIMEOUT_S=30",
        ),
    ),
    DocContractCheck(
    ...
    DocContractCheck(
        ...
        must_contain=(
            ...
            "WATCHDOG_SMOKE_FEISHU_DISCOVERY_HTTP_TIMEOUT_S",
        ),
    ),
    DocContractCheck(
    ...
    DocContractCheck(
        ...
        must_contain=(
            ...
            "scripts/watchdog_external_integration_smoke.py --target feishu-discovery",
            "WATCHDOG_SMOKE_FEISHU_CONTROL_HTTP_TIMEOUT_S",
            "WATCHDOG_SMOKE_FEISHU_DISCOVERY_EXPECTED_PROJECT_IDS",
            "WATCHDOG_SMOKE_PROVIDER_LIVE=true",
            "WATCHDOG_SMOKE_PROVIDER_HTTP_TIMEOUT_S",
