# 任务分解：028-webhook-response-api-reference-runtime

> 对应规格：`specs/028-webhook-response-api-reference-runtime/spec.md`

## Task 28.1 冻结 Feishu webhook / response contract

- **任务编号**：T281
- **状态**：已完成
- **目标**：把 Feishu webhook、receipt 与 response API 收敛成 stable contract。
- **涉及文件**：
  - `docs/architecture/codex-watchdog-full-product-loop-design.md`
  - `specs/028-webhook-response-api-reference-runtime/spec.md`
  - `specs/028-webhook-response-api-reference-runtime/plan.md`
  - `specs/028-webhook-response-api-reference-runtime/tasks.md`
...
- **涉及文件**：
  ...
  - `examples/feishu_webhook_runtime.py`
...
- `028` 是完整产品闭环中的 `WI-5`，只负责 Feishu 接入 contract 与 reference runtime。
