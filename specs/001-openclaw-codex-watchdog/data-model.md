...
- **A 侧**：`tasks`, `task_events`, `approvals`, `thread_mapping`, `handoff_summaries` 目录（PRD §12.1）
- **B 侧**：`watchdog_snapshots`, `watchdog_actions`, `approval_decisions`, `notification_history`（PRD §12.2）
