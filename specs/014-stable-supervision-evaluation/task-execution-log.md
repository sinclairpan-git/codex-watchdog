...
- 结果摘要：已冻结 stable supervision contract，落地 supervision evaluation 内核、stable action API 与 legacy evaluate 兼容壳，并把 OpenClaw adapter 接到 `evaluate_supervision` 闭环。
