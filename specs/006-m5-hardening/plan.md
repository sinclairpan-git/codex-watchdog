...
补齐 M5 与 §22 中不依赖飞书/OpenClaw 渠道的部分：可观测性、resume 状态、工作区摘要、Codex 占位、集成测试与 API/示例交付物。
...
5. `tests/integration/`、`scripts/export_openapi.py`、`examples/openclaw_watchdog_client.py`、`README` 增补 M5 说明。
