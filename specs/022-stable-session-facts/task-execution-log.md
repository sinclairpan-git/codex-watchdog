...
- 结果摘要：已冻结 stable session facts reply contract，补齐 facts reply builder、canonical facts route、Feishu `list_session_facts` intent，并明确 truth source 与 explanation layer 的边界。
