...
- 结果摘要：已冻结 stable session event contract 与 schema version，补齐 stable SSE projection / codec、stable events API、Feishu 只读事件消费闭环，以及 README / getting-started / OpenAPI 口径。
