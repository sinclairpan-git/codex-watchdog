# 任务分解：061-entry-routing-and-steer-contracts

> 对应规格：`specs/061-entry-routing-and-steer-contracts/spec.md`
>
> 对应计划：`specs/061-entry-routing-and-steer-contracts/plan.md`

## Task 61.1 冻结 061 owner 边界与 formal docs

- **任务编号**：T611
- **状态**：已完成
- **目标**：把 feishu entry routing / steer templates / enum contracts 收敛成 061 的 formal truth。
