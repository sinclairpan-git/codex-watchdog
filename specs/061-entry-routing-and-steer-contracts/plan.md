# Plan：061-entry-routing-and-steer-contracts

## 目标

把 Feishu entry routing / steer template / enum contract 这条剩余主题正式收敛为 061 的 canonical owner，并用 targeted verification 证明它已经成立。
...
- 固定 061 只覆盖 feishu entry routing / steer templates / enum contracts；
