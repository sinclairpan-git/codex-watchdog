...
- 已确认本机 launchd `com.openclaw.watchdog` 在 2026-04-19 之前仍运行旧进程；重启服务后，live `项目列表` 重新返回 `command_request + list_sessions + session_directory`，说明 runtime residual 根因是旧进程未刷新，而非仓库代码继续误路由。
