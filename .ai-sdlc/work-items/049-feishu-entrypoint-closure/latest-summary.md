...
## Notes
- `WI-049` 已从 `WI-047` 的 owner ledger 正式接手 92 条 Feishu / Feishu / natural-language 入口闭环条款。
- 当前边界已明确为 Feishu primary entrypoint、Feishu compatibility entrypoint 与自然语言到 canonical route 的统一映射。
