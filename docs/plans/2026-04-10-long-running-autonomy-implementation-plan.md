...
### Task 10: 收敛 release gate report shared loading API 与 evidence bundle

**Canonical execution work item:** `specs/039-release-gate-loading-api-and-evidence-bundle/`

**Files:**
- Modify: `src/watchdog/services/brain/release_gate.py`
- Modify: `src/watchdog/services/brain/release_gate_evidence.py`
- Create: `src/watchdog/services/brain/release_gate_loading.py`
- Modify: `src/watchdog/services/session_spine/orchestrator.py`
- Modify: `src/watchdog/api/ops.py`
- Modify: `src/watchdog/observability/metrics_export.py`
- Test: `tests/test_watchdog_release_gate.py`
- Test: `tests/test_watchdog_release_gate_evidence.py`
...
- [x] **Step 1: 写失败测试，冻结 shared report material/hash contract**
...
- [x] **Step 3: 实现最小 shared report material/hash contract**
...
### Task 12: formalize release gate artifact refresh / rebuild contract

**Canonical execution work item:** `specs/041-release-gate-artifact-refresh-and-rebuild-contract/`

**Files:**
- Create: `scripts/refresh_release_gate_artifacts.py`
- Modify: `scripts/generate_release_gate_report.py`
...
### Task 13: 收敛 release gate read-side consume contract

**Canonical execution work item:** `specs/042-release-gate-read-side-consume-contract/`

**Files:**
- Create: `src/watchdog/services/brain/release_gate_read_contract.py`
- Modify: `src/watchdog/api/ops.py`
- Modify: `src/watchdog/services/session_spine/orchestrator.py`
- Test: `tests/test_watchdog_ops.py`
- Test: `tests/test_watchdog_session_spine_runtime.py`
...
### Task 14: 收敛 policy engine typed runtime-gate contract

**Canonical execution work item:** `specs/043-policy-engine-typed-runtime-gate-contract/`
...
- [x] **Step 1: 写失败测试，冻结 policy engine typed validator consume contract**
...
- [x] **Step 3: 实现最小 typed validator consume contract**
...
### Task 16: 收敛 resident runtime release-gate evidence write-side contract

**Canonical execution work item:** `specs/045-resident-runtime-release-gate-evidence-write-contract/`
...
### Task 17: 收敛 session event gate payload write contract

**Canonical execution work item:** `specs/046-session-event-gate-payload-write-contract/`
