...
- `codex-watchdog-prd.md` 与 `docs/architecture/codex-long-running-autonomy-design.md` 中当前仍有效的 repo-local 义务，已被 `WI-035`、`WI-048`、`WI-049`、`WI-050` 的 formal owner 覆盖。
